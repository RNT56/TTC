...
export const session_policy_layout: (a: number) => [number, number, number, number];
export const session_policy_layout_v2: (a: number) => [number, number, number, number];
export const session_policy_observations: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const session_policy_observations_v2: (a: number, b: number, c: number, d: number) => [number, number, number, number];
