 ...
 */
export const HOVER_POLICY_FIXTURE_V2 = {
  schema: "forge-policy-tensor",
  schemaVersion: "2.0.0",
  coordinateFrame: "forge-y-up-rh-m",
  opset: 18,
  byteSize: 1056,
  sha256: "48c08ad27c27a5e78bb3b63ea722c14a2a8e35095c8a45ecbc1d8042f27976a0",
  modelBase64:
...
/** Exact read-compatibility oracle for the historical 11-scalar tensor. */
export const LEGACY_HOVER_POLICY_FIXTURE_V1 = {
  schema: "forge-policy-tensor",
  schemaVersion: "1.0.0",
  coordinateFrame: "forge-y-up-rh-m",
  opset: 18,
