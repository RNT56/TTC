...
quality on every capture, and preserves attempt diagnostics. Six policy tests pass.
The real local gallery passes all six unchanged structural gates at edge F1
0.957-0.995, 3 draws, and exact 4,662/2,208 WebGL triangle counts. The complete
...
**Next:** dispatch the workflow on this exact branch, inspect the full-Studio
preflight and six-scene artifact, then publish through protected PR/post-merge checks
and a final protected-main nightly before QA-012/G0 closure.
