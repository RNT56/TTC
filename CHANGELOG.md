...
sandbox install/upgrade/rollback exercise. Provider/Desktop propagation, external
telemetry storage, dashboards, alert delivery/acknowledgement, and managed/live/
production proof remain independent OPS-003 gates.
