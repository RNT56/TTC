...
D57/P8-004 is currently an unprotected local implementation candidate, not a new
runtime anchor. It introduces internal `forge-ghost-overlay/1.0.0` with exact
...
WebKit pass. Exact PR/protected-main, named-mid-hardware, real D54-to-twin, P8-014
and EXT-008 evidence remain outstanding. Raw recorder frames remain in D53/D54
objects and do not enter the maintenance payload.

## 2. Current verified results

| Check | Result | Interpretation |
|---|---|---|
| D57 local ghost-view candidate | Focused worker 33/33, Gateway 74/74, Studio 33/33, Studio typecheck/build, and 19-surface compatibility pass. The ten-minute fixture has 36,001 source samples, 6,001 render points, 601 seek entries, exact controlled-synthetic/nonclaim fields, strict Studio parser/refusal coverage, and indexed seek computation below the per-frame 60 Hz budget. All 40 local repository gates pass under Python 3.12.13 with 227 worker tests; a fresh clean/25-predecessor Postgres matrix, all 12 production-browser flows, and Chromium/Firefox/WebKit pass | proves only an unprotected local compact-artifact and interaction candidate. Exact PR/protected evidence, full render performance on named mid hardware, server-selected D54 replay/twin execution, and real field evidence are not yet proven |
...
| Desktop/hardware | fail-closed scaffold plus protected D48-D56 transport/readback/recorder/inspection/controls/materialization/admission/self-reported MSP identity and strict signed-custody mechanics; unprotected D57 candidate adds locally full-gate/database/browser-proven compact controlled-synthetic/unverified indexed ghost-view mechanics while preserving archive v1/D53/D54 and all device/field/sharing/training nonclaims | protect D57 through exact PR/post-merge evidence; execute D49/D55/D56 seams on named D12 hardware with a real trust bundle, rotation/revocation/suspend drills, and retained acceptance evidence; add server-selected D54 replay/admitted-twin execution; browser WebSerial/WebUSB; signed apps; real ghost/system-ID; Link image; lab/field proof |
...
| Claim D57 ghost-view protection | **No-go until exact PR/protected evidence** | focused worker/Gateway/Studio/build/compatibility evidence, all 40 local gates, clean/25-predecessor Postgres, 12/12 production-browser flows, and all three browser engines prove the unprotected candidate shape only. Exact PR/post-merge checks remain required. Even then, claim only controlled-synthetic/unverified compact-view mechanics; real D54 twin replay, full named-hardware render performance, P8-014 and EXT-008 remain separate no-go gates |
