...
Latest verified protected descendant: `370d214` (PR #97; D55 adapter identity)
...
| Git state | latest verified protected descendant and runtime anchor is D55 adapter identity `370d214`. D54 evidence `b4b5ad9`/admission `f8efb6f`, D53 materialization `08d892f`, D52 evidence `237e46b`/controls `a8120ab`, D51 evidence `9e81ddd`/runtime `b5418ac`, D50 evidence `225933a`/recorder `d8afe7f`, D49 evidence `63e144c`/target-readback `4647a10`, P8-012 evidence `15c3be2`/serial `fd26845`, and all listed P7/QA/DOC/release anchors remain green; annotated `v0.1.0` is published | PR #97 exact head `4321eaafd5d2c0ef60cf9f38cd1000d16d660668` passed CI `29519984713`/security `29519984764`; reviewed tree `673a50c94ecc17a2bd266542cd5f2c611d8a248b` is byte-identical at protected `370d214`, which passed post-merge CI `29520651520` and security `29520651581`. The implementation branch was deleted |
...
| Desktop/hardware | fail-closed scaffold plus protected D48 versioned native serial transport, protected D49 bounded pre/post `2025.12.x` target/readback, protected D50/P8-013 exclusive bounded background serial-JSONL recorder, protected D51 exact five-file archive-v1 streaming inspection, protected D52 shell-owned controls, protected D53 five-private-object materialization, protected D54 sovereign semantic admission, and protected D55 read-only two-pass self-reported MSP identity with all authority false | bind a reviewed trust/custody result to recorder start/end; execute D49/recorder seams on named D12 hardware; browser WebSerial/WebUSB; signed apps; ghost/system-ID; Link image; suspend/lab/field proof |
