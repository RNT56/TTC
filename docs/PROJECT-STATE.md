...
the DOC-005 closeout snapshot; current protected `f220d25` additively verifies 76
...
P7-014 has a locally verified but not yet protected ground-trainer candidate under
...
the ground tensor because no browser ground observer/actuator exists. The complete
39-step local gate passes with 174 worker tests and 13 Studio runtime tests. Exact-
head PR, protected-main CI/security, and downloaded clean-source smoke evidence are
still required before P7-014 can be marked complete.
...
| `pnpm verify` | current P7-014 candidate passes all 39 required non-DB gates locally under Python 3.12; P7-012 PR and protected required remote checks remain green | generated contract-doc drift joins migration source/history/checksum policy, external acceptance, browser support, golden/parity policy, Action pins, 15-surface compatibility, fmt, Clippy, full tests, WASM, schema, TS, 13 Studio tests, 65 gateway tests, Brief-25 25/25, oracles, budgets, boundary fuzz, sim, packaging, pilots, 174 worker tests, four-task training plus engine/MJX smokes, and patch hygiene; protected P7-012 CI `29426237373` also passes the 22-migration Postgres/MinIO/browser acceptance |
...
| P7-014 ground trainer candidate | complete 39-step local gate passes with 174 worker and 13 Studio tests; protected evidence is pending | D44 adds exact rover `[1,11] -> [1,2]` and current QD-Mini `[1,27] -> [1,8]` ground tensors, contract-only physics/control authority, estimator-only target progress, mass/torque/friction evaluation, mechanical-work energy, outer-worker/ONNX validation, four-task smoke, and Studio/unsupported-shape refusals. Do not claim protected, browser, device, or field closure yet |
...
| Claim P7-014 rover/quadruped trainer closure | **No-go pending protected evidence** | D44's complete local gate passes, but exact-head/protected CI/security and a downloaded clean-source four-task smoke have not yet been reconciled; Studio ground playback, external users, devices, and field transfer are separately open |
