...
Latest verified protected runtime descendant: `f7e7f57` (PR #104; D58 deployment-ladder rehearsal)
...
D59 controlled co-design engine candidate: current branch only; no protected anchor yet
...
D59/P9-002/P9-003 is an **unprotected local candidate** at
`local-engine-controlled-smoke` maturity. Three internal 1.0.0 envelopes bind the
...
| Git state | latest verified protected runtime anchor is D58 deployment-ladder rehearsal `f7e7f57`. D57 evidence `dd29789`/runtime `d33fd57`, D56 evidence `9035d09`/runtime `1bf127d`, D55 evidence `9e94c71`/runtime `370d214`, D54 evidence `b4b5ad9`/admission `f8efb6f`, D53 materialization `08d892f`, D52 evidence `237e46b`/controls `a8120ab`, D51 evidence `9e81ddd`/runtime `b5418ac`, D50 evidence `225933a`/recorder `d8afe7f`, D49 evidence `63e144c`/target-readback `4647a10`, P8-012 evidence `15c3be2`/serial `fd26845`, and all listed P7/QA/DOC/release anchors remain green; annotated `v0.1.0` is published | PR #104 exact head `3f3c4ecd9850b1958cc06ca8c3568bee23510866` passed CI `29541145577`/security `29541145559`; reviewed tree `4b36fac3a2c82736ca90ad4ff657bc50f20ebeb0` is byte-identical at protected `f7e7f57eaeee65cd7b4527118a00308205c6b15d`, which passed post-merge CI `29541456427`/security `29541456430`. The remote implementation branch was deleted |
...
| `pnpm verify` | protected D57 PR #102/`d33fd57` passes all 40 required gates under Python 3.12.13 | generated contract-doc drift, migration policy, external acceptance, registered golden updates, Action pins, Rust fmt/Clippy/tests, WASM/schema/TS, 33 Studio tests, 74 gateway tests, Brief-25 25/25, oracles, budgets, the governed 89-case boundary family, sim, packaging, pilots, 227 worker tests, four-task/offline/MJX smokes, and patch hygiene pass. Nineteen compatibility surfaces and 81 generated routes verify at the protected D57 tree |
...
| `pnpm verify:compatibility` | protected D57 PR #102/`d33fd57` passes 19/19 surfaces against policy 1.0.0 | ghost overlay v1 extends the existing worker-artifact surface while preserving every recorder/custody, policy tensor, gateway API/event, source, manifest, legacy, license, user-data, consent, lifecycle, and deprecation boundary |
| DOC-005 contract documentation | closed through protected PR #53 at `22c263b`; the current protected D57 reference verifies 81 runtime routes, 2 event families, 19 compatibility surfaces, and 17 worker families | D57 adds no route/event/worker family; the existing worker-artifact matrix and generated documentation remain drift-checked |
...
| Co-design | deterministic 200-candidate fixture/Pareto contracts plus an unprotected D59 controlled exact-snapshot engine candidate using sovereign native validation, real Rapier 0.33.0, and pinned MuJoCo 3.9.0 with strict lineage/readback and tier 3 held | protect D59; then actual CMA-ES/Optuna and catalog-choice search, ≥3 admitted Pareto points, 200 engine candidates overnight, trained finalists, provider scheduling/cost/recovery, and external acceptance |
...
| Claim D59 controlled co-design engine protection | **No-go until reviewed PR and protected-main evidence** | focused local tests and one release-binary three-candidate smoke prove the candidate shape only. Even after protection, D59 can authorize only `local-engine-controlled-smoke`: it cannot be cited as CMA-ES, Optuna, a 200-candidate overnight, ≥3 admitted Pareto points, trained finalist, provider sandbox, build readiness, hardware authority, or field evidence |
