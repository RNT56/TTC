...
| Git state | latest verified protected descendant is D64 catalog co-design `609a70d`; D63 exact-runtime authority is `54385c2`, D61 evidence reconciliation is `4ad8c8b`, D61 implementation is `1c37567`, D60 implementation is `71e7217`, D59 runtime is `fae00c5`, and all listed P7/P8/QA/DOC/release anchors remain green; annotated `v0.1.0` is published | PR #115 exact head `b13a817`, reviewed/protected tree `9934442`, PR CI/security `29561709484`/`29561709504`, protected `609a70d`, tree equality, and post-merge CI/security `29562278744`/`29562278736` pass |
...
| `pnpm verify` | protected D64 passes all 44 required gates under Python 3.12.13 | generated contract-doc drift, migration policy, external acceptance, registered golden updates, Action pins, Rust fmt/Clippy/tests, WASM/schema/TS, 39 Studio tests, 74 Gateway tests with no skips, Brief-25 25/25, oracles, budgets, the governed 89-case boundary family, sim, packaging, pilots, 246 worker tests, four-task/offline/MJX/D59-D64 policy and smokes, and patch hygiene pass locally, in PR, and after merge |
...
| `pnpm verify:compatibility` | protected D64 passes 19/19 top-level surfaces against policy 1.0.0 | D64 registers coordinated plan/evidence/batch/evidence 3.0.0, catalog-choice authority 1.0.0, catalog proof 1.0.0, and native evaluation 2.0.0 inside the worker-artifact surface while preserving every public format, queue kind, API/event, recorder/custody, policy tensor, source, manifest, legacy, license, user-data, consent, lifecycle, and deprecation boundary |
...
| Co-design | deterministic fixture/Pareto contracts; protected D59 exact-snapshot sovereign engine smoke; protected D60 real-CMA-ES/TPE 200-proposal plan; protected platform-scoped D61 consumes 200 exact hashes with durable recovery, 200 native/123 eligible Rapier-MuJoCo evaluations, 87 admissions, four Pareto points, and three tier-3-held finalists; protected D63 closes P9-006 with exact numeric-runtime scheduling/refusal and same-protected-source all-200 Linux/Apple comparison; protected D64 binds exact catalog-backed battery choices and catalog-aware native proof, with clean artifact `8399829664` evaluating 200/200 and admitting 197 into a two-point/two-finalist front | add a manifold that meets the separate `>=3` phase exit, catalog-native MuJoCo physics under a new bundle contract, actual trained-finalist scorecards, retained overnight/provider billing, and external acceptance; portable cache and heterogeneous resume remain deliberately unsupported |
...
Immediate refresh trigger: protect the D64 evidence reconciliation, then implement
the next dependency-complete P9 lane: catalog-native training-bundle physics under a
new contract and actual tier-3 finalist scorecards. The separate `>=3` physical
front and retained provider/overnight billing remain independent completion gates.
