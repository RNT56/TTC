...
| Git state | latest verified protected descendant is D61 implementation `1c37567`; D60 implementation is `71e7217`, D59 runtime is `fae00c5`, D58 runtime is `f7e7f57`, and all listed P7/P8/QA/DOC/release anchors remain green; annotated `v0.1.0` is published | D61 head `6c446a5`, reviewed tree `c6520fd`, PR #111 CI/security `29552818736`/`29552818716`, protected `1c37567`, protected-tree equality, post-merge CI/security `29553189264`/`29553189257`, and downloaded clean artifact `8396554544` pass |
...
| `pnpm verify` | D61 passes all 43 required gates locally and on protected main under Python 3.12.7 | generated contract-doc drift, migration policy, external acceptance, registered golden updates, Action pins, Rust fmt/Clippy/tests, WASM/schema/TS, 39 Studio tests, 74 Gateway tests, Brief-25 25/25, oracles, budgets, the governed 89-case boundary family, sim, packaging, pilots, 242 worker tests, four-task/offline/MJX/D59/D60/D61 smokes, and patch hygiene pass |
