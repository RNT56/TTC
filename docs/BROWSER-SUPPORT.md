...
that browser's acceptance contract.
...
version, engine/version, capability tier, WASM
asset, semantics, keyboard results, critical target dimensions, contrast ratios, and
