...
Live locally 2026-07-13: `/v1/account/export` emits versioned user-data format 1.1.0
...
receipt is intentionally primary-store-only. D34/SEC-004 adds independent,
...
future primary-plane eligibility. SEC-005 still owns retention, legal holds,
tombstones, and backup lifecycle.
