...
This UI and client are locally focused-test, 11-flow browser-E2E, three-engine
browser, and complete-repository green but remain unprotected until the PR/post-merge
gates pass.
