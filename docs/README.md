...
**New to the project:** add [`FORGE-plan.md`](FORGE-plan.md) (the binding v2.0 plan,
~30 min), then [`GLOSSARY.md`](GLOSSARY.md) and [`architecture.md`](architecture.md).
...
| Doc | Purpose | Nature |
|---|---|---|
| [`FORGE-plan.md`](FORGE-plan.md) | The complete plan v2.0 — vision, strategy, stack, engines, roadmap, decisions, appendices | **Frozen** planning paper (binding) |
| [`FORGE-vision-and-architecture.md`](FORGE-vision-and-architecture.md) | v1.0 predecessor paper | **Frozen**, historical — superseded by v2.0 |
...
| [`architecture.md`](architecture.md) | Five planes, monorepo layout, tech stack, deployment, performance budgets | Living |
...
|---|---|---|
| [`model-contract.md`](systems/model-contract.md) | Model Contract v2.1 — the JSON schema everything compiles from | P0, evolves always |
| [`validation-harness.md`](systems/validation-harness.md) | The sovereign gatekeeper: check catalog, diagnostic format, headless runner | P0–P2, evolves always |
| [`geometry-engine.md`](systems/geometry-engine.md) | Primitives, CSG, mass properties, interference, couplers, refit, DfM | P0–P1, P5 |
| [`render-engine.md`](systems/render-engine.md) | Three.js studio rendering, blueprint, explode, selection | P1 |
| [`motion-engine.md`](systems/motion-engine.md) | Archetype drivers, layer stack, IK, servos | P1–P2 |
| [`simulation-engine.md`](systems/simulation-engine.md) | Rapier coupling, propulsion/battery/estimator, replay, parity | P6 |
...
| [`hardware-bridge.md`](systems/hardware-bridge.md) | WebSerial, recorder/ghost, FORGE Link, deployment ladder, supervisor | P8 |
