...
| R18 | **Privacy/deletion promise exceeds implementation** | Med | High | D33 versioned user export plus fail-closed primary DB/blob deletion is locally proven; finish explicit consent/retention/legal-hold ledgers, object tombstones, and backup deletion/restore tests in SEC-004/005 | primary deletion leaves residue, a storage failure commits DB deletion, secrets enter an export, or backup/hold behavior cannot be proved |
