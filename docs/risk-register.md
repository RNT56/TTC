...
| R18 | **Privacy/deletion promise exceeds implementation** | Med | High | D33 export/primary deletion and D34 append-only purpose/subject consent are locally proven; finish retention/legal-hold records, object tombstones, and backup deletion/restore tests in SEC-005 | primary deletion leaves residue, a storage failure commits DB deletion, secrets enter an export, a stale/withdrawn grant authorizes work, or backup/hold behavior cannot be proved |
