...
| R20 | **Hosted Intel release latency makes artifact proof unreliable or prohibitively slow** | Med | Med | use the supported macOS 26 Intel image and measured thin-LTO release profile; cap native jobs at 60 minutes; preserve macOS 15 as a rollback through August 2027; cache Rust inputs; never weaken smoke/SBOM/attestation gates for speed | any native release job exceeds 30 minutes or times out |
