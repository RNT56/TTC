...
- [~] SEC-006 — Threat-model auth/session/BYO-key/provider callbacks/object URLs/job payloads/SSRF/prompt injection/zip or model bombs and add negative tests/rate limits. *(started 2026-07-13 on `codex/sec006-threat-boundaries`; implementation and proof in progress)*
