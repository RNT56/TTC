...
- [~] P10-004 — Course sharing by URL; courses as community objects *(2026-06-14: courses table/routes/visibility live with validator report persistence; Studio now includes an editable EnvSpec course form with name/visibility controls; public course URL polish remains open)*
...
- [~] P12-004 — Fleet view *(2026-06-14: fleet-summary worker live; maintenance job outputs materialize records; Studio now renders a fleet dashboard with counts, due service, critical state, next actions, wear, crash, repair, and reorder rows; live fleet data/field evidence remains open)*
