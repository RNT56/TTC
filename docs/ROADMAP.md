...
D49's current local candidate requires the props-removed phrase, a bounded exact
...
private lab evidence can be resolved without committing device output. Two real
pseudo-terminal sessions prove the protocol and fail-closed
