...
| P7 Training service | ◑ *(2026-07-15: P7-003, P7-008, P7-011, P7-012, and P7-014 are protected: exact admitted-snapshot/Rust-bundle CPU MuJoCo/SB3 training, browser playback, object-backed delivery, scorecard-passing hover/waypoint consumer-hardware evidence, and contract-derived rover/quadruped trainers all retain their owning PR/artifact evidence. P7-010's protected CPU MuJoCo/MJX feasibility row passes parity but remains decision-ineligible pending exact D12 accelerator/budget/cost evidence. P7-009 now has a D45 implementation candidate on protected base `f0bb4e2`: one consented gateway-owned telemetry log feeds an exact source/task/tensor-bound BC dataset, 12 behavior-cloning epochs, 256 randomized PPO steps, ONNX, and the unchanged scorecard. The complete 40-step local gate passes with migration 0023, 17 worker families, 188 worker tests, 65 gateway tests, and repeated hover/rover same-seed dataset/warmstart/ONNX smoke; short controlled-synthetic scorecards remain blocked and `recorded-device` is rejected pending P8 attestation. Protect and inspect that candidate before closing P7-009. Recorded-device data, deployed Modal/GPU operations, ground browser playback, final MJX decision, production storage operations, and EXT-003 remain open under P8/P7-010/P7-013/OPS-006.)* | 4 wk |
