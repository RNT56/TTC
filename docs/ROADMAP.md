...
| P7 Training service | ◑ *(2026-07-15: task specs, obs/action derivation, domain randomization, curriculum metadata, fixture train.policy/train.sysid-fit jobs, external SB3 scorecard re-gating, ONNX headers/blob-linked policy artifacts, and P7-008's protected digest-bound opset-18 hover playback through lazy exact ONNX Runtime Web 1.27.0/WASM against Rust estimator observations. Live SB3/MuJoCo training, object-backed external models, offline fine-tune, MJX proof, and EXT-003 remain open.)* | 4 wk |
