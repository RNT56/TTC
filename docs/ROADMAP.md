...
| P7 Training service | ◑ *(2026-07-16: P7-003, P7-008, P7-009, P7-011, P7-012, and P7-014 are protected: exact admitted-snapshot/Rust-bundle CPU MuJoCo/SB3 training, browser playback, source-bound controlled-synthetic offline fine-tuning, object-backed delivery, scorecard-passing hover/waypoint consumer-hardware evidence, and contract-derived rover/quadruped trainers retain their owning PR/artifact evidence. P7-013's D46 deployment-control contract/fixture is now protected through PR #79/`ff39cd8`: an exact source-bound Modal 1.5.2/L4 function, CUDA/no-fallback authority, durable provider-call attempts, shared Postgres quotas, cancellation/refund fencing, migration 0024, a strict sandbox-evidence validator, and a complete operator runbook pass exact PR/post-merge CI/security and the clean 24-migration database/browser matrix. P7-013 remains `[~]` until one real clean-protected provider run proves billing attribution, alerts/SLO, spend stop, cancellation, application-artifact deletion, verified automatic provider-call expiry within seven days, and recovery. P7-010's protected CPU feasibility row remains decision-ineligible; the current unprotected D47 candidate adds an exact three-proxy `mjxDecisionRequest` 2.0.0, 12-hour scorecard/200-candidate budgets, provider cost authority, GPU/TPU no-fallback enforcement, and a complete operator runbook, but still needs protection and one real clean supported-accelerator/budget/cost run. Recorded-device data, exact passing-policy delivery integration, ground browser playback, final MJX decision, production storage operations, and EXT-003 remain open under P8/P7-010/P7-013/OPS-006.)* | 4 wk |
