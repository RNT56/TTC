...
| P9 Co-design | ◑ *(2026-07-16 D59 protected controlled smoke: the deterministic 200-candidate fixture and admitted-point Studio flow remain; the exact-snapshot engine seam executes three-to-nine inline multirotor variants through sovereign native validation, deterministic real Rapier 0.33.0, and pinned MuJoCo 3.9.0, with strict lineage/readback and tier 3 held. Proof admits 2/3, returns one Pareto point, and passes the 50 ms release-native tier-0 SLO; all 41 required repository gates pass under Python 3.12.7 with 233 worker tests. PR #106/`fae00c5` protects exact tree and CI/security evidence. Actual CMA-ES/Optuna, catalog choices, ≥3 Pareto points, 200 engine candidates overnight, trained finalists, and provider proof remain open.)* | 4 wk |
