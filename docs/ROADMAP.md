...
- [x] Hover-class task to passing scorecard overnight on one consumer GPU *(PR #72/protected `8e094c0`; clean M2 Pro evidence intentionally interrupts/resumes and retains exact hover/waypoint JSON/ONNX under `docs/evidence/p7-012/`. Both pass unchanged baseline/mass/Kv/wind gates. D43 records CPU execution on the GPU-capable host and honest energy/cost nonclaims.)*
