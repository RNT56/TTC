...
| P7 Training service | ◑ *(2026-07-15: P7-003, P7-008, P7-009, P7-011, P7-012, and P7-014 are protected: exact admitted-snapshot/Rust-bundle CPU MuJoCo/SB3 training, browser playback, source-bound controlled-synthetic offline fine-tuning, object-backed delivery, scorecard-passing hover/waypoint consumer-hardware evidence, and contract-derived rover/quadruped trainers retain their owning PR/artifact evidence. P7-009 closes through PR #77/protected `2c7562d`: one consented gateway-owned telemetry log feeds an exact source/task/tensor-bound BC dataset, 12 behavior-cloning epochs, 256 randomized PPO steps, ONNX, and the unchanged scorecard. The 40-step gate, 23-migration isolated database/browser matrix, 17 worker families, 188 worker tests, 65 gateway tests, and clean artifact `8359446894` pass; repeated hover/rover dataset/warmstart/ONNX digests are exact, short scorecards remain blocked, and `recorded-device` is rejected pending P8 attestation. P7-010's protected CPU MuJoCo/MJX feasibility row passes parity but remains decision-ineligible pending exact D12 accelerator/budget/cost evidence. Recorded-device data, deployed Modal/GPU operations, exact passing-policy delivery integration, ground browser playback, final MJX decision, production storage operations, and EXT-003 remain open under P8/P7-010/P7-013/OPS-006.)* | 4 wk |
