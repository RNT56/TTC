...
gates pass under Python 3.12.13. D55 now supplies an unprotected full-gate local read-only
identity-observation candidate: exact MSP-v1 commands 1/2/3/4/5/160, strict protocol
...
cryptographic attestation and is not yet bound to recorder start/end. Protection,
trusted custody, real-device, suspend, and lab/field execution proceed only under
