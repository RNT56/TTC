...
| P9 Co-design | ◑ *(2026-07-17: D59's exact-snapshot engine smoke, D60's 100-CMA-ES/100-TPE plan, D61's 200-row consumer, D63's exact-runtime recovery authority, D64's exact catalog battery search, and D65's catalog-bound tier-2 physics are protected through PR #117/`ad54ab3`. Protected D65 artifact `8402573520` binds clean bundle v3/physics v1/batch v4 catalog mass, sourced-dimension inertia, MuJoCo mass closure, and per-rollout table applicability; it evaluates 200/200, admits 97, and returns two held battery points at 0.769/0.756 kg. The 6S/5×4.6 table is correctly rejected for the 4S/5×4.3 fixture and named analytic fallbacks drive the curve. All 44 local/PR/protected gates pass with 246 worker, 74 Gateway, and 39 Studio tests. Portable cache, heterogeneous resume, per-point-voltage format support, applicable catalog-thrust data, a separate `>=3` physical front, actual tier-3 scorecards, retained overnight/provider billing proof, and external acceptance remain open.)* | 4 wk |
...
single-voltage tables must not be merged implicitly. PR #117 exact head `d8d18ad`,
