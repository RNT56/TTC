...
| P4 Text-to-CAD GA | ◑ *(deterministic real-validator gate restored to 25/25; SEC-002..005 are protected and SEC-006 application bounds pass locally; live extraction, deployed egress/quotas/backup/DR, and external R1 proof remain gated)* | 3–4 wk |
