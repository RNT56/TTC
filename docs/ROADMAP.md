...
| P7 Training service | ◑ *(2026-07-15: P7-003 is protected through PR #64/`d1c4c38`: the controlled exact-pinned CPU MuJoCo/SB3 hover runtime owns admitted snapshot/Rust bundle authority, real seeded PPO/SAC, executable randomization, robustness evaluation, deterministic ONNX export, and a required clean source-bound smoke. P7-008 browser playback remains protected. Overnight passing hover/waypoint proof, one-click object-backed delivery, deployed Modal/GPU operations, offline fine-tune, broader real tasks, MJX proof, and EXT-003 remain open as P7-009..014.)* | 4 wk |
