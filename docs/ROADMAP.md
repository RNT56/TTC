...
Gateway materialization, real adapter/device, suspend, and field proof remain owned
...
CI/security protect it. The next dependency-complete local slice is a separately
designed object-backed gateway import/materialization path; real adapter/device and
