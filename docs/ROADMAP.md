...
| P9 Co-design | ◑ *(2026-07-17: D59's exact-snapshot sovereign engine smoke is protected through PR #106/`fae00c5`; D60's exact 100-CMA-ES/100-TPE proposal plan is protected through PR #109/`71e7217`; and D61's platform-scoped engine batch is protected through PR #111/`1c37567` with artifact `8396554544`. PR #113/protected `54385c2` closes P9-006 through D63's exact-runtime authority/refusal after an all-200 Linux/Apple comparison confirms 80 CMA-ES differences. PR #115/protected `609a70d` now protects D64's exact catalog-backed battery choices, catalog-aware native proof, and same-authority 7 + cancel + 193 recovery. Clean artifact `8399829664` evaluates 200/200 native/Rapier/MuJoCo rows, admits 197, and returns the expected two-choice/two-point front with two held finalists. Portable cache, heterogeneous resume, and cross-runtime tier 3 remain false. Catalog-native tier-2 physics, a separate `>=3` physical front, actual tier-3 scorecards, retained overnight/provider billing proof, and external acceptance remain open.)* | 4 wk |
...
persistence, catalog-native tier-2 physics, tier-3 training, retained overnight/
provider scheduling and billing, course-conditioned objectives, and external
