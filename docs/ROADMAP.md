...
| P4 Text-to-CAD GA | ◑ *(deterministic real-validator gate restored to 25/25 on 2026-07-12 and local SEC-002 refusal/audit enforcement added 2026-07-13; live extraction, user-content privacy, and external R1 proof remain gated)* | 3–4 wk |
...
| P11 Platform | ◑ *(local platform contracts plus D10 license-aware exporter enforcement are implemented; external users, policy gate/process ownership, and provider handoffs remain gated)* | open |
