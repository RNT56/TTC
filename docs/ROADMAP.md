...
| P9 Co-design | ◑ *(2026-07-17: D59's exact-snapshot three-to-nine-candidate sovereign native/Rapier/MuJoCo smoke is protected through PR #106/`fae00c5`; it admits 2/3, returns one Pareto point, and passes the 50 ms tier-0 SLO within all 41 protected gates. D60's proposal plan is protected through PR #109/`71e7217`: 100 pinned CMA-ES plus 100 pinned Optuna TPE proposals retain exact hashes and no physical/engine feedback. D61 is protected at platform-scoped engine-batch maturity through PR #111/`1c37567`; artifact `8396554544` proves 7 + zero-dispatch cancel + 193 resume, 200 native/123 eligible Rapier-MuJoCo rows, 87 admissions, four Pareto points, and three tier-3-held finalists. D62/P9-006 records Apple-arm64/Linux-x86-64 CMA-ES hash drift at ordinals 20–99. D63's coordinated v2 exact-runtime-authority candidate now binds platform/Python/NumPy/BLAS/LAPACK/algorithm distribution identity into plans, caches, checkpoints, and candidates; focused tests pass 11/11, all 44 local gates pass with 244 workers, and foreign resume fails before work. It remains local/dirty diagnostic evidence until clean-source, protected, same-revision Linux/Apple comparison, and reconciliation proof exist. Catalog choices, actual tier-3 training, retained overnight/provider billing proof, and external acceptance remain open.)* | 4 wk |
...
Exit criteria:
- [~] "Lightest quad for this course under constraints" returns ≥ 3 admitted Pareto points overnight *(protected D61 returns four independently derived engine-admitted Pareto points, but it is platform-scoped and neither course-conditioned nor overnight/provider evidence. D63 locally implements exact-runtime scheduling/refusal; P9-006 protection/comparison plus those external gates remain open.)*
- [~] Tier-0 candidate evaluation < 50 ms native; 200-candidate CMA-ES generation overnight at tier 2 *(D59's protected release-binary runs pass the separate sovereign native 50 ms SLO. D60 produces 200 real-algorithm proposals. Protected D61 consumes all 200 through native and 123 eligible Rapier/MuJoCo rows with durable recovery. D63 refuses foreign resume but lacks protected same-revision cross-platform proof; retained overnight/provider schedule and billing remain open.)*
- [~] Every returned point is a fully admitted contract (validator as constraint oracle) *(D59 protects the small exact-snapshot constraint-oracle seam. Protected D61 derives its complete front only from admitted sovereign rows and keeps partial fronts empty. D63 binds exact numeric-runtime authority locally; P9-006 protection/reconciliation, catalog choices, and actual trained finalists remain open.)*
...
replay but is not portable. Cross-platform plan/recovery authority, catalog choices,
actual trained-finalist scorecards, provider/overnight operations, and external
acceptance still prevent P9 closure.

D63 is the coordinated D62 recovery format candidate. Internal search-plan/evidence
...
cannot grant portability or tier-3 authority. Focused tests pass 11/11 and a dirty
Apple-arm64 diagnostic preserves the D61 front/finalists; all 44 local gates pass
with 244 worker, 74 Gateway, and 39 Studio tests. Clean exact-source,
protected Linux, same-protected-source Apple, comparison, and reconciliation proof
are still required to close P9-006.
