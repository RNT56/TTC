...
| P9 Co-design | ◑ *(2026-07-17: D59's exact-snapshot three-to-nine-candidate sovereign native/Rapier/MuJoCo smoke is protected through PR #106/`fae00c5`; it admits 2/3, returns one Pareto point, and passes the 50 ms tier-0 SLO within all 41 protected gates. D60's 42-gate-green proposal plan is protected through PR #109/`71e7217`: 100 pinned CMA-ES plus 100 pinned Optuna TPE proposals retain deterministic hashes and no physical/engine feedback. Catalog choices, ≥3 admitted Pareto points, evaluating 200 exact hashes through engines overnight, trained finalists, and provider proof remain open.)* | 4 wk |
