...
| P4 Text-to-CAD GA | ◑ *(deterministic real-validator gate restored to 25/25; local SEC-002 refusal/audit and SEC-003 owner export/primary deletion pass 2026-07-13; live extraction, consent/retention/backup lifecycle, and external R1 proof remain gated)* | 3–4 wk |
...
| P11 Platform | ◑ *(local platform contracts, D10 license-aware exports, and D33 user export/primary deletion are implemented; consent/retention/backup lifecycle, external users, policy process ownership, and provider handoffs remain gated)* | open |
