...
| Deployment/operations | `infra/deployment`, `infra/docker`, `infra/compose.hardened.json`, `scripts/deployment-policy.mjs`, `scripts/hardened-runtime.mjs`, `docs/OPERATIONS.md` | D68 environment/manifest/promotion and D69 image/runtime authority; build once, exact artifacts, file-mounted secrets, private topology, least privilege, forward-only migrations, no managed/live claim from contract or CI evidence |
