...
- the SEC-006 contract/fixture runtime evidence remains anchored at protected PR #31
  ...
  latest verified protected descendant is D60 evidence-reconciliation PR #110 at
  `d8fce83`. D60 implementation head `340c88d` passed PR #109 CI/security
  `29549718149`/`29549718173`; reviewed tree `7139ad5` is byte-identical at protected
  `71e7217`, whose post-merge CI/security `29550088422`/`29550088452` pass. Evidence
  head `7d47458` passed PR #110 CI/security `29550659673`/`29550659692`; protected
  `d8fce83` passed post-merge CI/security `29550988172`/`29550988170`. D57
  evidence-
...
- D60/P9-002 is protected at
  ...
  plan;
- D61/P9-002/P9-003 is a local `local-engine-200-batch` candidate, not a protected or
  overnight result. Internal engine-batch/evidence 1.0.0 formats deterministically
  replay D60, accept its exact 200 hashes, retain one ordinal-contiguous checkpoint
  after every candidate, fence interrupted attempts, and prove cancellation advances
  no cursor. Partial/cancelled results expose no Pareto or finalists. The completed
  development smoke executes 7 + cancel + 193, evaluates all 200 natively and 125
  eligible rows through Rapier 0.33.0/MuJoCo 3.9.0, admits 89, returns four Pareto
  points, and selects three real engine-admitted finalists with tier 3 held. It
  records measured local engine hours with provider amount/currency/
  billing and energy absent. That first run came from a dirty implementation
  worktree and is diagnostic only. All 43 local gates pass under Python 3.12.7 with
  242 worker, 74 Gateway, and 39 Studio tests; a clean exact-source repeat and
  protected PR/post-merge evidence, catalog choices, actual tier-3 training,
  overnight/provider operations, build, hardware, and field authority remain open;
