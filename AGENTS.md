...
- controlled hardware evidence remains D30/D12-only: rover before quad, local
  ...
  and unattested; retain them as observation evidence only, bind a reviewed trust/
  custody result at recorder start and stop, and require named-hardware/lab evidence
